...
heatmap.pre.cor = list(
  "D16C"=data.frame(NAME=heatmap.input[[1]]$NAME, count1=heatmap.input[[1]][, 5]),
  "D25Cm"=data.frame(NAME=heatmap.input[[2]]$NAME, count2=heatmap.input[[2]][, 5]),
  "D25Cp"=data.frame(NAME=heatmap.input[[3]]$NAME, count3=heatmap.input[[3]][, 4]),
  "D25Gp"=data.frame(NAME=heatmap.input[[4]]$NAME, count4=heatmap.input[[4]][, 5])
)
...
correlation.output = cor(heatmap.merged.cor[, -1])
colnames(correlation.output) = rownames(correlation.output) = c("D16 C", "-D25 C", "+D25 C", "+D25 G")
