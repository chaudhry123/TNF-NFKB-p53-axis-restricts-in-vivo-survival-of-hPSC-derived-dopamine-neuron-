...
c1 <- FeaturePlot(combined_sce1, feature="ENSG00000197921", order=T, pt.size=1.0) + labs(title="HES5") + scale_colour_gradientn(colours = terrain.colors(10)) 
print(c1)
FeaturePlot(combined_sce1, feature="ENSG00000148773", order=T, pt.size=1.0) + labs(title="MKI67") + scale_colour_gradientn(colours = terrain.colors(10))
c2 <- print(c2)
